    ...
    <AlertDialog onOpenChange={onOpenChange} open={open}>
      <AlertDialogContent data-testid="agent-delete-confirm-dialog">
        ...
        <ul className="list-disc space-y-1.5 pl-5 text-sm text-muted-foreground">
          ...
          <li>
            {isProviderAgent
              ? "Unless the agent is known to be Offline, Dreamforge first requests shutdown through a channel when available. A failed request cancels deletion. The remote process may still be running even after a successful request."
