...
const HARNESS_DESCRIPTIONS: Record<string, string> = {
  // Built-in runtimes.
  "buzz-agent": "Dreamforge's built-in agent runtime, bundled with the app.",
  ...
  cursor:
    "Cursor's coding agent, connected to Dreamforge through its ACP server.",
  ...
  grok: "xAI's coding agent, connected to Dreamforge through its ACP entrypoint.",
