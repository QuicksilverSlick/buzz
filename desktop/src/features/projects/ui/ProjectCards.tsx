...
function RepositoryUnavailableIndicator({
  ...
  const status = {
    authentication: {
      description: "Dreamforge could not authenticate with this repository.",
      label: "Access failed",
    },
    missing: {
      description: "No git repository was found on the Dreamforge relay.",
      label: "Uninitialized",
    },
    access: {
      description:
    ...
    network: {
      description: "The Dreamforge git service could not be reached.",
      label: "Unreachable",
    },
    ref: {
    ...
    unknown: {
      description: "Dreamforge could not load this repository.",
      label: "Unavailable",
    },
  } satisfies Record<
